...
class TestFrontPageView(ResolverTestCase):
    ...
    @patch('dirigible.info_pages.views.non_logged_in_front_page_view')
    ...
    @patch('dirigible.info_pages.views.user_dashboard')
...
class TestNonLoggedInFrontPageView(ResolverTestCase):
    ...
    @patch('dirigible.info_pages.views.render_to_response')
